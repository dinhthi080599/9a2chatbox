					...
					<div class="card-body contacts_body">
						...
						<li class="active">
							<div class="d-flex bd-highlight">
								<div class="img_cont">
									<img src="./img/ava_cuathi.jpg" class="rounded-circle user_img">
									<span class="online_icon"></span>
								</div>
								<div class="user_info">
									<span>9A2 forever love</span>
									<p>Ai cũng đáng yêu</p>
								</div>
							</div>
						</li>
						<!-- <li>
					...
					<div class="card">
						<div class="card-header msg_head">
							<div class="d-flex bd-highlight">
								...
								<div class="user_info">
									<span>Chát cùng 9A2</span>
									<p>có rất nhiều tin nhắn trong nhóm này ♥ </p>
								</div>
								<div class="video_cam">
